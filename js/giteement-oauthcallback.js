...
function(e, t, n) {
	...
	t.getTargetContainer = function(e) {
		var t = void 0;
		t = e instanceof Element ? e: i(e) ? document.getElementById(e) : document.createElement("div");
		return t
	};
	var o = n(2),
	...
	function a(e) {
		return function(t) {
			...
			"GET" !== e && "DELETE" !== e && (s = JSON.stringify(n), i.setRequestHeader("Content-Type", "application/json")),
			i.send(s),
			l
		}
	}

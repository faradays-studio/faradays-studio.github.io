//HHJ@20210214，将评论仓库放在 gitee 站点（暂未测试！！！）
			...
			default)({},
				{
					...
					proxy: "https://cors-anywhere.herokuapp.com/https://gitee.com/login/oauth/access_token",
					flipMoveOptions: {
						staggerDelayBy: 150,
		...
		default)(t, [{
				...
				default.createElement("p", {
						dangerouslySetInnerHTML: {
							__html: this.i18n.t("no-found-related", {
								link: '<a href="https://gitee.com/' + o + "/" + i + '/issues">Issues</a>'
							})
						}
					}), b.
			...
			},
			{
				...
				get: function() {
					...
					return "https://gitee.com/login/oauth/authorize?" + (0, N.queryStringify)(t)
				}
			},
			{
				key: "isAdmin",
			...
			c), {
				...
				u = a.nodes.map(function(t) {
					...
					return {
						...
						body: t.body,
						html_url: "https://gitee.com/" + r + "/" + o + "/issues/" + e.number + "#issuecomment-" + t.databaseId,
